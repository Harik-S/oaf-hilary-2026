...
THRESHOLD = 0.05
session_signals_short['signal'] = (session_signals_short['vrp'] > THRESHOLD) & (session_signals_short['iv_rank'] > 40)

session_signals_long['signal'] = (session_signals_long['vrp'] < -THRESHOLD) & (session_signals_long['iv_rank'] < 40)
